...
# parte al medio.
tellraw @s ["", {"text": "\n"}, {"text": "  Bienvenido a ", "color": "gray"}, {"text": "SOBRINOS DE PEPE", "color": "#ffb02e", "bold": true}, {"text": "\n\n"}, {"text": "  Todo se abre desde ", "color": "gray"}, {"text": "/comandos", "color": "#00a6ff", "bold": true, "click_event": {"action": "run_command", "command": "/comandos"}, "hover_event": {"action": "show_text", "value": {"text": "Clickealo para abrir el menu", "color": "gray"}}}, {"text": "   \u00ab clickealo", "color": "dark_gray"}, {"text": "\n"}, {"text": "  La tienda, tu casa, el PvP y la tienda de shards.", "color": "gray"}, {"text": "\n"}]
